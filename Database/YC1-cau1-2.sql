...
-- Cấp quyền cho Role_NVCB và các Role khác
GRANT SELECT, UPDATE(DT) ON View_NHANVIEN_Read_Self TO Role_NVCB, Role_TRGDV, Role_NV_TCHC, Role_NV_CTSV, Role_GV, Role_NV_PDT, Role_NV_PKT ;
